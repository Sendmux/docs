...
<CardGroup cols={2}>
  ...
  <Card title="Mailbox push delivery" icon="bell-ring" href="/mailboxes/push-delivery">
...
<CardGroup cols={2}>
  <Card title="Dashboard and logs" icon="list" href="/monitoring/dashboard-logs">
  ...
  <Card title="AI integrations" icon="robot" href="/ai-integrations/agent-skills">
