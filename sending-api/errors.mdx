...
**HTTP 402**: A Pro team's balance is too low to send this email or batch. Top up the team balance under **Billing**.
...
**HTTP 429**: A Free team's accepted and in-flight recipients have reached the limit of 10 for the current UTC day. The message is rejected before it enters the delivery queue. Wait for the `Retry-After` period or upgrade the team to Pro before retrying.
