...
| --- | --- | --- |
| Sending | `GET https://smtp.sendmux.ai/api/v1/me` | A Sending credential with `email.send`. |
| Management | `GET https://app.sendmux.ai/api/v1/me` | A root API key; no additional read permission. |
| Mailbox | `GET https://app.sendmux.ai/api/v1/mailbox/connection` | A mailbox credential or supported Mailbox access token; no additional read permission. |
