...
curl "https://app.sendmux.ai/api/v1/mailbox/messages/msg_123/attachments/att_123" \
  ...
  --output invoice.part <<< "Authorization: Bearer $SENDMUX_API_KEY"
```
...
<Columns cols={2}>
  ...
  <Card title="Synchronisation" icon="arrows-rotate" iconType="solid" href="/developer-tools/mailbox-api/sync"></Card>
</Columns>
