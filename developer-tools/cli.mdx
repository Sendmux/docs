...
The self-registered inbox is capped at 500 MiB before approval. Sending approval raises it to 5 GiB before the CLI can obtain a delegated sending token. Revoking sending later does not shrink the inbox.
