...
TypeScript, Python, Go, PHP, Ruby, and Rust clients also accept [REST OAuth tokens and token providers](/developer-tools/oauth). Use the token option documented for your language; API-key prefix requirements apply to API-key configuration.
...
| Go | `sendmux.ai/go/v3` | `sending`, `mailbox`, `management`, and `sdk` subpackages |
...
<CardGroup cols={2}>
  ...
  <Card title="MCP servers" icon="plug" href="/ai-integrations/mcp">
