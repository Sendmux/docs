...
To edit several accounts, select them and open **Update Variables**. **Merge keys** adds or overwrites supplied keys, **Replace all** replaces each map, and **Remove keys** deletes named keys. Each resulting map must satisfy the limits. Review any reported failures after applying the edit.
