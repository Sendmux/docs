...
<Columns cols={2}>
  ...
  <Card title="Sending errors" icon="triangle-alert" href="/sending-api/errors#idempotency_conflict">
    Handle conflicts from single and batch sends.
  </Card>
  <Card title="Management API errors" icon="triangle-alert" href="/api/errors#idempotency_conflict">
