...
<Steps>
  <Step title="Create or choose a team">
    ...
    See [Teams and access](/account/teams-and-access) if you need to invite someone or change roles.
  </Step>
  ...
  <Step title="Create a mailbox">
    ...
    See [Mailboxes](/mailboxes) for sender identity, storage, and sender rules.
  </Step>
