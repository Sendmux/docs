---
title: "JetBrains AI Assistant MCP setup"
description: "Configure Sendmux MCP in JetBrains AI Assistant."
keywords: ["JetBrains AI Assistant","MCP client","Sendmux MCP","MCP setup"]
---
