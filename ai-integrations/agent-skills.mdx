...
The self-registered inbox is capped at 500 MiB before approval. Owner-approved sending first raises storage to 5 GiB, and later send revocation does not shrink it.
