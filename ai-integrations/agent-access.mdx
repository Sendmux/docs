...
After the owner accepts the invite, the team uses normal Sendmux limits. Free teams must upgrade to Pro for more capacity. Eligible paid teams can request reviews where the app offers them. The owner can approve or revoke agent sending from the **Agent access** card on the team page.
