...
<Note>
  New Free teams include **2 active mailboxes**. Free limits are fixed. Delete
  an unused mailbox or upgrade to Pro when you need more capacity. See [Team
...
[Sending API](/sending/http). For mailbox-style workflows, call
`POST /mailbox/messages/send` through the [Mailbox API](/mailbox-api/introduction)
...
<Columns cols={2}>
  ...
  <Card title="Push delivery" icon="radio" href="/mailboxes/push-delivery">
