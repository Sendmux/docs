...
**HTTP 409**: Your team has hit the create limit for this resource. The limit can apply to domains, mailboxes, sending accounts, webhooks, or active API keys. A Free team must delete an existing item or upgrade to Pro before retrying. A legacy team can request an increase where the app offers one. See [Team limits](/account/team-limits).
