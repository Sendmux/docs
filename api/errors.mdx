...
**HTTP 409**: Your team has reached the create limit for this resource. This can apply to domains, mailboxes, sending accounts, webhooks, or active API keys. On Free, delete an existing item or upgrade to Pro before retrying. See [Team limits](/account/team-limits).
