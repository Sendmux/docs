...
The shared Amazon SES account is protected. You can read, activate, or deactivate it. Free limits are fixed. Eligible Pro and legacy teams can request a daily limit review at 80% usage. You cannot edit its credentials, quotas, routing weight, sender defaults, or delete it through the API.
