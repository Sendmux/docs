...
| --------------------- | -------------------------- | ------------------------------------------------- | ----------------------------------------- |
| `part`                | `auto`, `text`, `html`     | `auto`                                            | Message content, thread content           |
| `max_body_chars`      | `1` to `1000000`           | `100000` for messages, `25000` per thread message | Raw body, message content, thread content |
| `strip_signature`     | `true`, `false`            | `true`                                            | Message content, thread content           |
| `strip_quotes`        | `true`, `false`            | `true`                                            | Message content, thread content           |
| `include_links`       | `true`, `false`            | `true`                                            | Message content, thread content           |
| `include_html`        | `true`, `false`            | `false`                                           | Message content, thread content           |
| `include_headers`     | `none`, `selected`, `full` | `selected`                                        | Message content, thread content           |
| `include_attachments` | `none`, `metadata`         | `metadata`                                        | Message content, thread content           |
