...
**HTTP 409** — Your team has reached the create limit for this resource. This can apply to domains, mailboxes, sending accounts, webhooks, or active root API keys. Request an increase from the relevant page in the Sendmux app, or delete an existing item before retrying. See [Team limits](/guides/team-limits).
