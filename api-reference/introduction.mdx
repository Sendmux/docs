...
API keys are scoped to a team and carry specific permissions. Create and manage keys under **Settings > API Keys** in the Sendmux app. Each team starts with **100 active root API keys**; mailbox-scoped credentials are separate. See [Team limits](/guides/team-limits).
