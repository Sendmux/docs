...
API keys are scoped to a team and carry specific permissions. Create and manage keys under **Settings > API Keys** in the Sendmux app. Each team starts with **100 active API keys** across root keys and mailbox-class credentials, including send-only and mailbox-scoped keys. See [Team limits](/guides/team-limits).
