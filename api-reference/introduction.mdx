...
The Sendmux Management API gives you programmatic access to your email workspace: read providers, metrics, and delivery logs; manage domains, mailboxes, API keys, and webhook subscriptions; track billing balance and history.
