...
| ---------------- | ------------- | -------------------------------------------- |
| Domains          | 25            | [Domains](/domains)         |
| Mailboxes        | 50            | [Mailboxes](/mailboxes)               |
| Sending accounts | 200           | [Sending accounts](/sending/accounts) |
| Webhooks         | 10            | [Webhooks setup](/webhooks/setup)     |
| Credentials      | 100           | [API keys](/account/api-keys)                 |
