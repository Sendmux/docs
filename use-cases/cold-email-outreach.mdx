...
<Accordion title="How many sending accounts can I add?">
  New Free teams include one account you add or connect yourself. The managed
  account does not count towards that. See [Account
  limits](/sending/accounts#account-limits) and [Team
  limits](/account/team-limits) for capacity requests.
</Accordion>
