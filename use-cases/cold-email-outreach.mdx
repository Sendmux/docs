...
<Note>
  ...
  message and records it in [Logs](/monitoring/dashboard-logs#delivery-logs) rather
...
<Steps>
  <Step title="Add the server">
    ...
    in [Hosted OAuth clients](/ai-integrations/mcp/clients#hosted-oauth-clients).
  </Step>
  ...
  <Step title="Check the tools appear">
    ...
    [Verify the connection](/ai-integrations/mcp/clients#verify-the-connection).
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="How many sending accounts can I add?">
    ...
    [Account limits](/sending/accounts#account-limits) and
    [Default limits](/account/team-limits#default-limits).
  </Accordion>
...
<Columns cols={2}>
  ...
  <Card title="Deliverability" icon="shield-halved" href="/monitoring/deliverability">
