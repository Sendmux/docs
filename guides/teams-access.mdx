...
When an agent invites an owner through [agent access](/guides/agent-access), the owner joins the team from the email invitation. After joining, open the team page and use the **Agent access** card to approve or revoke that agent's sending capability.
