...
Use the Postman collection when you want to test Product MCP requests from Postman:
...
<AccordionGroup>
  ...
  <Accordion title="Local server fails before starting">
    Check the API key prefix. Management needs `smx_root_`; Mailbox and Sending need `smx_mbx_`.
  </Accordion>
