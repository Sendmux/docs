...
<Steps>
  ...
  <Step title="Review and authorise">
    Review the requested access, then select **Authorise**. Management
    permissions are grouped by area with **None**, **Read**, **Full**, and
    **Customise** choices, so you can open individual scopes only when you need
    them.
  </Step>
</Steps>
