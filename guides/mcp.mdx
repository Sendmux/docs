...
<Steps>
  ...
  <Step title="Enter the Sendmux MCP URL">
    Enter `https://docs.sendmux.ai/mcp` as the server URL.
  </Step>
  <Step title="Save and start asking">
    Save the connector and start asking Claude about Sendmux.
  </Step>
</Steps>
