...
Prefer Postman's web app? Open the [published Sendmux collection](https://www.postman.com/sendmux/sendmux-email-inbox-api-sending/overview), then fork it into your workspace.
