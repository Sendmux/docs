...
Prefer Postman's web app? Open the [published Sendmux collection](https://www.postman.com/sendmux/workspace/sendmux-email-inbox-api-sending), then fork it into your workspace.
