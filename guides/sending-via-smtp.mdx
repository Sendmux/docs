...
<Note>
  Provider and delivery-group routing follows the configured scope of the API key you authenticate with as the SMTP password — not a message header. See [Route through a delivery group](/guides/sending-accounts#route-through-a-delivery-group).
</Note>
