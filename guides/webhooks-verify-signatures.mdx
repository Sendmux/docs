...
description: "Verify the HMAC-SHA256 signature Sendmux attaches to every webhook delivery, with ready-to-paste examples."
...
<Warning>
  Always use a **constant-time** comparison. Plain string `==` leaks byte-level timing information an attacker can use to forge a valid signature.
</Warning>
