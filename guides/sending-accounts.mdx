...
<Steps>
  ...
  <Step title="Complete setup">
    SMTP accounts need host, port, protocol, username, password, and optional
    sender defaults. Connected accounts send you through the provider's sign-in
    flow.
  </Step>
...
Use the [Management API](/api-reference/introduction#sending-account-management) when you need to automate account operations.
