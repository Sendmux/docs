...
<Update label="18 August 2026" tags={["Bug fixes"]} rss={{ title: "New inbox messages now update unread counts reliably" }}>
  ## Bug fixes

New email now updates your personal unread count even when a message takes a moment to appear in your inbox. The count catches up automatically without a page reload.
