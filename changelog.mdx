...
<Update label="20 August 2026" tags={["New features", "Improvements"]} rss={{ title: "Free and Pro plans add clearer limits and per-email pricing" }}>
  ## Free and Pro plans

Free now includes two mailboxes and up to 10 provider-accepted recipients per UTC day across all sending routes. Its limits are fixed. When a team needs more capacity, the owner can upgrade to Pro instead of requesting an allowance.

Pro costs \$7 per team each month, plus usage. Outgoing mail through your own or connected provider costs \$0.000500 per provider-accepted recipient occurrence. Managed Amazon SES sending costs \$0.000750 per provider-accepted recipient occurrence. Inbound mail costs \$0.000500 per distinct mailbox delivery. Each event is billed individually, not in blocks of 1,000.

Existing Free teams stay on Free until an owner upgrades them. Existing paying teams keep their current access during the change.
