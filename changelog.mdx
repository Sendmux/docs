...
- Thread lists now stay aligned with the current mailbox, folder, and search when a refresh finishes after you have already switched views.
- Starting another compose action while a draft is open now saves the current draft before replacing the compose window.
