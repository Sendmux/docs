...
Re-authorising the same MCP connected app now replaces earlier active grants for that app, so **API keys** shows one current connection instead of stale duplicate connected-app rows.
