...
Inbox counts and conversation lists now update when new email arrives, even while you are viewing another page. Returning after a connection interruption refreshes the current state automatically.
