...
<Update label="29 May 2026" tags={["New features","Improvements"]} rss={{ title: "Team dashboard health, activity, and inbox signals are clearer" }}>
  ## Dashboard

The team overview now shows a clearer health summary with recent sending, receiving, webhook, billing, domain, API key, and capacity signals in one place.

Activity charts now use precomputed rollups so dashboard refreshes stay fast for busy teams.
