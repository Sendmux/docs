...
Delivery and incoming log date filters now include the full selected end date, so choosing a date includes activity from that whole day instead of stopping at midnight.

Log pages, CSV exports, and API log lists now apply date filters consistently, keeping result counts aligned across refreshes and exports.
