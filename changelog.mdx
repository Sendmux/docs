...
The agent access, API key, SDK, CLI, MCP, and Sending API docs now describe which token types work for each surface and how owner approval fits into `auth.md` adoption.
