...
<Update label="25 June 2026" tags={["New features", "Improvements", "Bug fixes"]} rss={{ title: "Team settings, agent approvals, and mailbox sending fixes" }}>
  ## Notifications
...
Agent-created `@myagent.mx` mailboxes can now send after owner approval without requiring a custom domain.
