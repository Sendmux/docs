...
- Starting another compose action while a draft is open now saves the current draft before replacing the compose window, including when the draft is minimised.
