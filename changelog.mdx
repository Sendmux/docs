...
<Update label="26 July 2026" tags={["Bug fixes"]} rss={{ title: "Accepted emails no longer retry during follow-up tracking failures" }}>
  ## Bug fixes

Emails accepted by your configured provider no longer retry when delivery logging or usage tracking is temporarily unavailable. This prevents the same accepted email from being sent or charged twice.
