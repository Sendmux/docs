...
From 24 September 2026 at 02:00 UTC, Free includes two mailboxes and up to 50 provider-accepted recipients per UTC day across all sending routes. Free limits are fixed, so reaching one prompts the team owner to upgrade to Pro instead of requesting a higher allowance.
