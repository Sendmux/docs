...
- Delivery log statuses now use short readable labels instead of raw provider event strings.
- Dashboard hover details now avoid repeating the same health summary in more than one place.
- Billing runway and usage-capacity cards now use clearer labels and interactions.
