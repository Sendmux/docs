...
The public `auth.md` examples and agent-auth metadata now use the current `identity_endpoint` field and Sendmux-prefixed extensions without older compatibility aliases.
