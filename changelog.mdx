...
<Update label="25 June 2026" tags={["New features", "Bug fixes"]} rss={{ title: "Notifications and agent approval fixes" }}>
  ## Notifications

The app now has a Notifications panel in the account menu, with unread counts, read controls, and a new **Notifications** settings tab for choosing email and in-app updates by category.

Agent sending approvals now appear as actionable notifications, so owners can jump straight to the approval flow from the notifications panel.
