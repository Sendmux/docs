...
<Update label="19 May 2026" tags={["New features","Improvements"]} rss={{ title: "Mailbox API adds clean content retrieval, thread sync, operational resources, and safer writes" }}>
