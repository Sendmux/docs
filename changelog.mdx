...
Connection tests now pace checks that target the same mail server. Large account pools can continue in the background without opening too many connections at once, and the progress window shows verified, failed, and deferred totals separately.
