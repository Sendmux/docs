...
- Creating a mailbox on the shared Sendmux domain now repairs missing platform state before provisioning the mailbox, so generated addresses no longer fail when required domain records are missing.
