...
Your personal Inbox unread count now updates when a message is moved to another folder, including moves made outside Sendmux. New email still increases the count normally, and each teammate keeps their own read state.
