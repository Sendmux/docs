...
Hosted MCP authorisation now lets you choose the right team before granting access. The requested resources refresh when you switch teams, so connected apps only see what that team can use.
