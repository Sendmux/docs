...
<Update label="21 July 2026" tags={["Bug fixes"]} rss={{ title: "Shared mailbox sends now use the correct sending route" }}>
  ## Bug fixes

Emails sent from an active shared mailbox through the Sending API or hosted agent tools now use that mailbox's sending route instead of being incorrectly rejected.
