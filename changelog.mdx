...
Agents can exchange their claim token after owner approval to get a send-capable `smx_agent_` token for the Sending API, without a human copying a separate API key.
