...
Domains can now be set up for sending only, or for sending and receiving. Sending-only domains require ownership, SPF, DKIM, and DMARC records, and leave incoming mail with your current provider.
