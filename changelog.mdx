...
SMTP sending now accepts valid sender addresses before choosing a delivery path, preventing a `MAIL FROM required` rejection for messages that should use your configured providers.
