...
The agent access guide now tells agents to save the full credential bundle in a secure store before reporting setup success, so later MCP, CLI, SDK, mailbox, and sending workflows can continue without re-registering.
