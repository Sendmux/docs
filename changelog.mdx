...
Mailbox sending setup now handles already-existing delivery event notifications during recovery, so retries can complete instead of stopping on duplicate setup state.
